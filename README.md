...
- `--data_augmentation`: apply on-the-fly transformations (ColorJitter, RandomAffine, GaussianBlur) to training images to improve robustness against lighting variations, glare, and slight out-of-focus scenarios.
