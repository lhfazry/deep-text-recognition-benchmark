...
def inference(opt):
    ...
    # prepare data
    AlignCollate_inference = AlignCollate(imgH=opt.imgH, imgW=opt.imgW, keep_ratio_with_pad=opt.PAD)
    ...
    try:
        ...
        print(f'Could not open image: {opt.image_path}')
        return
        
    image_tensors, _ = AlignCollate_inference([(image, '')])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', required=True, help='path to image file for inference')
